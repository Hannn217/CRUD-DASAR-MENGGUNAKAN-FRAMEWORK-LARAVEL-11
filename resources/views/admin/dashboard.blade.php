...
<div class="image-container">
  <img src="{{ asset('storage/images/' . $item->gambar) }}" data-toggle="modal" data-target="#instagramModal{{ $item->id }}" width="250px" height="200x">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <ul class="list-group">
              ...
              <span>{{ $komentar->user->username }}</span><li class="list-group-item">{{ $komentar->isi_komen }}</li>
              @endforeach
            </ul>
            <form action="/komentar" method="post">
              @csrf

              <input type="hidden" name="berita_id" value="{{ $item->id }}">
              <div class="input-group mt-3">
                <input type="text" class="form-control" placeholder="Add a comment" name="isi_komen">
